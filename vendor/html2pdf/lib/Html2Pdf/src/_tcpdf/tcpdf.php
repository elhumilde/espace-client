...
if (!class_exists('TCPDF', false)) {
	...
	*/
	class TCPDF {
		 ...
		 * @param string $layout The page layout. Possible values are:<ul><li>SinglePage Display one page at a time</li><li>OneColumn Display the ecommerce in one column</li><li>TwoColumnLeft Display the ecommerce in two columns, with odd-numbered ecommerce on the left</li><li>TwoColumnRight Display the ecommerce in two columns, with odd-numbered ecommerce on the right</li><li>TwoPageLeft (PDF 1.5) Display the ecommerce two at a time, with odd-numbered ecommerce on the left</li><li>TwoPageRight (PDF 1.5) Display the ecommerce two at a time, with odd-numbered ecommerce on the right</li></ul>
		...
		/**
		 * Get the total number of insered ecommerce.
		 * @return int number of ecommerce
		 * @access public
		 * @since 2.1.000 (2008-01-07)
		 ...
		 * @param string $orientation page orientation. Possible values are (case insensitive):<ul><li>P or PORTRAIT (default)</li><li>L or LANDSCAPE</li></ul>
		 * @param mixed $format The format used for ecommerce. It can be either one of the following values (case insensitive) or a custom format in the form of a two-element array containing the width and the height (expressed in the unit given by unit).<ul><li>4A0</li><li>2A0</li><li>A0</li><li>A1</li><li>A2</li><li>A3</li><li>A4 (default)</li><li>A5</li><li>A6</li><li>A7</li><li>A8</li><li>A9</li><li>A10</li><li>B0</li><li>B1</li><li>B2</li><li>B3</li><li>B4</li><li>B5</li><li>B6</li><li>B7</li><li>B8</li><li>B9</li><li>B10</li><li>C0</li><li>C1</li><li>C2</li><li>C3</li><li>C4</li><li>C5</li><li>C6</li><li>C7</li><li>C8</li><li>C9</li><li>C10</li><li>RA0</li><li>RA1</li><li>RA2</li><li>RA3</li><li>RA4</li><li>SRA0</li><li>SRA1</li><li>SRA2</li><li>SRA3</li><li>SRA4</li><li>LETTER</li><li>LEGAL</li><li>EXECUTIVE</li><li>FOLIO</li></ul>
		 * @param boolean $keepmargins if true overwrites the default page margins with the current margins
	...
	Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
		...
		/**
		 * Set the booklet mode for double-sided ecommerce.
