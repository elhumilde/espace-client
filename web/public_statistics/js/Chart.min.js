    ...
    })(
        {
            ...
            2: [
                function (t, e, n) {
                    ...
                    var y = t(6);
                    e.exports = { getRgba: i, getHsla: a, getRgb: r, getHsl: l, getHwb: o, getAlpha: s, hexString: u, rgbString: d, rgbaString: c, percentString: h, percentaString: f, hslString: g, hslaString: p, hwbString: m, keyword: v };
                    var k = {};
                ...
                function (t, e, n) {
                    var i = t(5),
                        ...
                        o = function (t) {
                            ...
                            var e;
                            "string" == typeof t
                                ? ((e = a.getRgba(t)), e ? this.setValues("rgb", e) : (e = a.getHsla(t)) ? this.setValues("hsl", e) : (e = a.getHwb(t)) && this.setValues("hwb", e))
                                : "object" == typeof t &&
                                  ((e = t),
                ...
                function (t, e, n) {
                    ...
                    function z(t) {
                        var e,
                            ...
                            l = t[2];
                        return (
                            o <= 8 ? ((n = (100 * o) / 903.3), (a = 7.787 * (n / 100) + 16 / 116)) : ((n = 100 * Math.pow((o + 16) / 116, 3)), (a = Math.pow(n / 100, 1 / 3))),
                            ...
                            (t.controllers.bar = t.DatasetController.extend({
                                ...
                                getStackCount: function (t) {
                                    ...
                                    for (e = 0; e < l; ++e)
                                        (n = a.getDatasetMeta(e)),
                                            n.bar && a.isDatasetVisible(e) && (r === !1 || (r === !0 && s.indexOf(n.stack) === -1) || (void 0 === r && (void 0 === n.stack || s.indexOf(n.stack) === -1))) && s.push(n.stack);
                                    return s.length;
                                },
                                ...
                                getRuler: function () {
                                    ...
                                    return (
                                        ...
                                        { stackCount: a, tickSize: r, categorySize: l, categorySpacing: r - l, fullBarSize: s, barSize: u, barSpacing: s - u, scale: n }
                                    );
                                },
                                    ...
                                    if (g || (void 0 === g && void 0 !== p))
                                        for (n = 0; n < t; ++n)
                                            (i = u.getDatasetMeta(n)),
                                                i.bar && i.stack === p && i.controller.getValueScaleId() === c.id && u.isDatasetVisible(n) && ((a = Number(h[n].data[e])), ((f < 0 && a < 0) || (f >= 0 && a > 0)) && (m += a));
                                ...
                                calculateBarIndexPixels: function (t, e, n) {
                                    var i = this,
                                        ...
                                        s = n.barSize;
                                    return (l -= o ? n.tickSize / 2 : 0), (l += n.fullBarSize * r), (l += n.categorySpacing / 2), (l += n.barSpacing / 2), { size: s, base: l, head: l + s, center: l + s / 2 };
                                },
                                draw: function () {
                                    var t,
                                        n = this,
                                ...
                                setHoverStyle: function (t) {
                                    var n = this.chart.data.datasets[t._datasetIndex],
                                        ...
                                        a = t.custom || {},
                                        o = t._model;
                                    (o.backgroundColor = a.hoverBackgroundColor ? a.hoverBackgroundColor : e.getValueAtIndexOrDefault(n.hoverBackgroundColor, i, e.getHoverColor(o.backgroundColor))),
                                        (o.borderColor = a.hoverBorderColor ? a.hoverBorderColor : e.getValueAtIndexOrDefault(n.hoverBorderColor, i, e.getHoverColor(o.borderColor))),
                                        (o.borderWidth = a.hoverBorderWidth ? a.hoverBorderWidth : e.getValueAtIndexOrDefault(n.hoverBorderWidth, i, o.borderWidth));
                                },
                            ...
                            (t.controllers.bubble = t.DatasetController.extend({
                                ...
                                updateElement: function (n, i, a) {
                                    ...
                                    e.extend(n, {
                                        ...
                                        _index: i,
                                        _model: {
                                            x: a ? l.getPixelForDecimal(0.5) : l.getPixelForValue("object" == typeof c ? c : NaN, i, f, o.chart.isCombo),
                                    ...
                                    generateLabels: function (t) {
                                        ...
                                        return n.labels.length && n.datasets.length
                                            ? n.labels.map(function (i, a) {
                                                  ...
                                                  return { text: i, fillStyle: c, strokeStyle: h, lineWidth: f, hidden: isNaN(r.data[a]) || o.data[a].hidden, index: a };
                                              })
                                            : [];
                                    },
                                },
                            ...
                            (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                                ...
                                updateElement: function (t, n, i) {
                                    ...
                                    e.extend(t, {
                                        ...
                                        _index: n,
                                        _model: { x: u + o.offsetX, y: d + o.offsetY, startAngle: c, endAngle: h, circumference: g, outerRadius: m, innerRadius: p, label: v(f.label, n, o.data.labels[n]) },
                                    });
                                    var b = t._model;
                                    this.removeHoverStyle(t),
                                        (i && s.animateRotate) || (0 === n ? (b.startAngle = l.rotation) : (b.startAngle = a.getMeta().data[n - 1]._model.endAngle), (b.endAngle = b.startAngle + b.circumference)),
                                        t.pivot();
                                },
                                removeHoverStyle: function (e) {
                                ...
                                updateBezierControlPoints: function () {
                                    ...
                                    if (
                                        ...
                                        for (e = 0, i = d.length; e < i; ++e)
                                            (a = d[e]),
                                                (o = a._model),
                                                (r = n.splineCurve(n.previousItem(d, e)._model, o, n.nextItem(d, e)._model, s.dataset._model.tension)),
                            ...
                            (t.controllers.polarArea = t.DatasetController.extend({
                                ...
                                updateElement: function (t, n, i) {
                                    ...
                                    e.extend(t, {
                                        ...
                                        _index: n,
                                        _scale: u,
                                        _model: { x: f, y: g, innerRadius: 0, outerRadius: i ? w : x, startAngle: i && s.animateRotate ? b : y, endAngle: i && s.animateRotate ? b : k, label: d(c, n, c[n]) },
                                    }),
                            ...
                            (t.controllers.radar = t.DatasetController.extend({
                                ...
                                setHoverStyle: function (t) {
                                    ...
                                    (o.radius = i.hoverRadius ? i.hoverRadius : e.getValueAtIndexOrDefault(n.pointHoverRadius, a, this.chart.options.elements.point.hoverRadius)),
                                        (o.backgroundColor = i.hoverBackgroundColor ? i.hoverBackgroundColor : e.getValueAtIndexOrDefault(n.pointHoverBackgroundColor, a, e.getHoverColor(o.backgroundColor))),
                                        (o.borderColor = i.hoverBorderColor ? i.hoverBorderColor : e.getValueAtIndexOrDefault(n.pointHoverBorderColor, a, e.getHoverColor(o.borderColor))),
                                        (o.borderWidth = i.hoverBorderWidth ? i.hoverBorderWidth : e.getValueAtIndexOrDefault(n.pointHoverBorderWidth, a, o.borderWidth));
                                },
                                removeHoverStyle: function (t) {
                                    var n = this.chart.data.datasets[t._datasetIndex],
                                        i = t.custom || {},
                                    ...
                                    (o.radius = i.radius ? i.radius : e.getValueAtIndexOrDefault(n.pointRadius, a, r.radius)),
                                        (o.backgroundColor = i.backgroundColor ? i.backgroundColor : e.getValueAtIndexOrDefault(n.pointBackgroundColor, a, r.backgroundColor)),
                                        (o.borderColor = i.borderColor ? i.borderColor : e.getValueAtIndexOrDefault(n.pointBorderColor, a, r.borderColor)),
                                        (o.borderWidth = i.borderWidth ? i.borderWidth : e.getValueAtIndexOrDefault(n.pointBorderWidth, a, r.borderWidth));
                                },
                            }));
                    };
                },
                ...
                function (t, e, n) {
                    ...
                    e.exports = function (t) {
                        ...
                        (t.defaults.global.animation = { duration: 1e3, easing: "easeOutQuart", onProgress: e.noop, onComplete: e.noop }),
                            (t.Animation = t.Element.extend({ chart: null, currentStep: 0, numSteps: 60, easing: "", render: null, onAnimationProgress: null, onAnimationComplete: null })),
                            (t.animationService = {
                                frameDuration: 17,
                                animations: [],
                                dropFrames: 0,
                                ...
                                advance: function (t) {
                                    for (var n, i, a = this.animations, o = 0; o < a.length; )
                                        (n = a[o]),
                                            ...
                                            n.currentStep >= n.numSteps ? (e.callback(n.onAnimationComplete, [n], i), (i.animating = !1), a.splice(o, 1)) : ++o;
                                },
                            }),
                                    ...
                                    (i = r[e]),
                                        ...
                                        i.model.skip ||
                                            ...
                                            (o.almostEquals(i.deltaK, 0, this.EPSILON)
                                                ? (i.mK = a.mK = 0)
                                                : ((u = i.mK / i.deltaK), (d = a.mK / i.deltaK), (h = Math.pow(u, 2) + Math.pow(d, 2)), h <= 9 || ((c = 3 / Math.sqrt(h)), (i.mK = u * c * i.deltaK), (a.mK = d * c * i.deltaK))));
                                var f;
                                for (e = 0; e < l; ++e)
                                    (i = r[e]),
                                        i.model.skip ||
                        ...
                        var r = (o.easingEffects = {
                            ...
                            easeInElastic: function (t) {
                                ...
                                return 0 === t
                                    ...
                                    : 1 === (t /= 1)
                                    ? 1
                                    : (n || (n = 0.3), i < Math.abs(1) ? ((i = 1), (e = n / 4)) : (e = (n / (2 * Math.PI)) * Math.asin(1 / i)), -(i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / n)));
                            },
                            easeOutElastic: function (t) {
                                ...
                                return 0 === t
                                    ...
                                    : 1 === (t /= 1)
                                    ? 1
                                    : (n || (n = 0.3), i < Math.abs(1) ? ((i = 1), (e = n / 4)) : (e = (n / (2 * Math.PI)) * Math.asin(1 / i)), i * Math.pow(2, -10 * t) * Math.sin(((1 * t - e) * (2 * Math.PI)) / n) + 1);
                            },
                            easeInOutElastic: function (t) {
                                ...
                                return 0 === t
                                    ...
                                    : (n || (n = 1 * (0.3 * 1.5)),
                                      ...
                                      t < 1 ? -0.5 * (i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / n)) : i * Math.pow(2, -10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / n) * 0.5 + 1);
                            },
                    ...
                    e.exports = function (t) {
                        ...
                        t.layoutService = {
                            ...
                            update: function (t, a, o) {
                                ...
                                function u(t) {
                                    t.isHorizontal()
                                        ? ((t.left = t.fullWidth ? h : L), (t.right = t.fullWidth ? a - f : L + I), (t.top = q), (t.bottom = q + t.height), (q = t.bottom))
                        ...
                        (t.defaults.scale = {
                            ...
                            (t.Scale = t.Element.extend({
                                ...
                                fit: function () {
                                    ...
                                    if (
                                        (d ? (a.width = t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth) : (a.width = u && s.drawTicks ? f : 0),
                                        ...
                                        if (d) {
                                            ...
                                            var k = t.ticks[0],
                                                ...
                                                S = e(t.ctx, M, c.font);
                                            0 !== t.labelRotation
                                                ? ((t.paddingLeft = "bottom" === o.position ? b * w + 3 : b * m + 3), (t.paddingRight = "bottom" === o.position ? b * m + 3 : b * S + 3))
                                ...
                                draw: function (e) {
                                    ...
                                    if (o.display) {
                                        ...
                                        if (p) {
                                            if (
                                                ...
                                                (M + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) &&
                                                    (r = 1 + Math.floor(((M + d.autoSkipPadding) * a.ticks.length) / (a.width - (a.paddingLeft + a.paddingRight)))),
                                                l && a.ticks.length > l)
                                            )
                                        ...
                                        if (
                                                ...
                                                if (void 0 !== t && null !== t) {
                                                    ...
                                                    if ((!s || l) && void 0 !== t && null !== t) {
                                                        ...
                                                        n === ("undefined" != typeof a.zeroLineIndex ? a.zeroLineIndex : 0)
                                                            ? ((h = c.zeroLineWidth), (g = c.zeroLineColor), (m = c.zeroLineBorderDash), (v = c.zeroLineBorderDashOffset))
                                            ...
                                            i.each(S, function (t) {
                                                if (
                                                    ...
                                                    var e = t.label;
                                                    if (i.isArray(e)) for (var n = 0, a = 0; n < e.length; ++n) s.fillText("" + e[n], 0, a), (a += 1.5 * v.size);
                                            ...
                                            if (p) (P = a.left + (a.right - a.left) / 2), (_ = "bottom" === o.position ? a.bottom - y.size / 2 : a.top + y.size / 2);
                                                ...
                                                (P = F ? a.left + y.size / 2 : a.right - y.size / 2), (_ = a.top + (a.bottom - a.top) / 2), (T = F ? -0.5 * Math.PI : 0.5 * Math.PI);
                                            }
                                        ...
                                        if (c.drawBorder) {
                                            ...
                                            p ? ((V = O = "top" === o.position ? a.bottom : a.top), (V += z), (O += z)) : ((R = L = "left" === o.position ? a.right : a.left), (R += z), (L += z)),
                                                s.beginPath(),
                                                s.moveTo(R, V),
                                                s.lineTo(L, O),
                                                s.stroke();
                        ...
                        t.Ticks = {
                            generators: {
                                ...
                                logarithmic: function (t, n) {
                                    ...
                                    0 === l
                                        ? ((i = Math.floor(e.log10(n.minNotZero))), (a = Math.floor(n.minNotZero / Math.pow(10, i))), o.push(l), (l = a * Math.pow(10, i)))
                        ...
                        (n.elements.arc = { backgroundColor: n.defaultColor, borderColor: "#fff", borderWidth: 2 }),
                            (t.elements.Arc = t.Element.extend({
                                ...
                                inRange: function (t, n) {
                                    var i = this._view;
                                    if (i) {
                                        for (var a = e.getAngleFromPoint(i, { x: t, y: n }), o = a.angle, r = a.distance, l = i.startAngle, s = i.endAngle; s < l; ) s += 2 * Math.PI;
                                        for (; o > s; ) o -= 2 * Math.PI;
                                        for (; o < l; ) o += 2 * Math.PI;
                                        var u = o >= l && o <= s,
                                ...
                                draw: function () {
                                    ...
                                    for (
                                        ...
                                        (i = d[t]),
                                            ...
                                            (o = i._view),
                                            0 === t ? o.skip || (s.moveTo(o.x, o.y), (h = t)) : ((a = h === -1 ? a : d[h]), o.skip || ((h !== t - 1 && !u) || h === -1 ? s.moveTo(o.x, o.y) : e.canvas.lineTo(s, a._view, i._view), (h = t)));
                                    s.stroke(), s.restore();
                                },
                            }));
                    };
                ...
                function (t, e, n) {
                    ...
                    e.exports = function (t) {
                        ...
                        var i = t.helpers,
                            a = t.defaults.global,
                            o = a.defaultColor;
                        (a.elements.point = { radius: 3, pointStyle: "circle", backgroundColor: o, borderWidth: 1, borderColor: o, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 }),
                                ...
                                draw: function () {
                                    ...
                                    if (
                                        (u.horizontal
                                            ...
                                            : ((e = u.x - u.width / 2), (n = u.x + u.width / 2), (i = u.y), (a = u.base), (o = 1), (r = a > i ? 1 : -1), (l = u.borderSkipped || "bottom")),
                                        d)
                                    ) {
                ...
                function (t, e, n) {
                    ...
                    e.exports = function (t) {
                        ...
                        function n(t, n) {
                            ...
                            if (((t._chartjs = { initial: { height: a, width: o, style: { display: i.display, height: i.height, width: i.width } } }), (i.display = i.display || "block"), null === o || "" === o)) {
                                var r = e(t, "width");
                                void 0 !== r && (t.width = r);
                            }
                            if (null === a || "" === a)
                        ...
                        function l(t, e, n, i, a, l) {
                            ...
                            for (t.beginPath(), s = 0, u = p + !!l; s < u; ++s)
                                (d = s % p),
                                    ...
                                    (f = o(c)),
                                    (g = o(h)),
                                    f && g ? ((x = v.push(c)), (y = b.push(h))) : x && y && (m ? (f && v.push(c), g && b.push(h)) : (r(t, v, b, x, y), (x = y = 0), (v = []), (b = [])));
                            ...
                            afterDatasetsUpdate: function (o, r) {
                                ...
                                for (s = 0; s < c; ++s)
                                    (l = o.getDatasetMeta(s)),
                                        (u = l.dataset),
                                        (d = null),
                                        u && u._model && u instanceof t.elements.Line && (d = { visible: o.isDatasetVisible(s), fill: e(u, s, c), chart: o, el: u }),
                                        (l.$filler = d),
                                        f.push(d);
                                        ...
                                        if (((l.font = f), m)) {
                                            ...
                                            (l.textAlign = "left"),
                                                ...
                                                i.each(n.legendItems, function (t, i) {
                                                    ...
                                                    v[v.length - 1] + r + o.padding >= n.width && ((b += d + o.padding), (v[v.length] = n.left)), (g[i] = { left: 0, top: 0, width: r, height: d }), (v[v.length - 1] += r + o.padding);
                                                }),
                                                (p.height += b);
                                        } else {
                                            var x = o.padding,
                                            ...
                                            i.each(n.legendItems, function (t, n) {
                                                ...
                                                M + S > p.height && ((k += w + o.padding), y.push(w), (w = 0), (M = 0)), (w = Math.max(w, a)), (M += S), (g[n] = { left: 0, top: 0, width: a, height: d });
                                            }),
                                                (k += w),
                                                y.push(w),
                                                (p.width += k);
                                ...
                                draw: function () {
                                    ...
                                    if (a.display) {
                                        ...
                                        var b = e(o, g),
                                            ...
                                            w = n.isHorizontal();
                                        d = w ? { x: n.left + (s - u[0]) / 2, y: n.top + o.padding, line: 0 } : { x: n.left + o.padding, y: n.top + o.padding, line: 0 };
                                        var M = g + o.padding;
                                        i.each(n.legendItems, function (t, e) {
                                            ...
                                            w
                                                ...
                                                : l + M > n.bottom && ((r = d.x = r + n.columnWidths[d.line] + o.padding), (l = d.y = n.top + o.padding), d.line++),
                                                y(r, l, t),
                                                (x[e].left = r),
                                                (x[e].top = l),
                                                k(r, l, t, i),
                ...
                function (t, e, n) {
                    ...
                    e.exports = function (t) {
                        ...
                        var n = t.helpers,
                            ...
                            a = n.noop;
                        return (
                            (t.defaults.global.title = { display: !1, position: "top", fullWidth: !0, weight: 2e3, fontStyle: "bold", padding: 10, text: "" }),
                                    ...
                                    if (o.display) {
                                        ...
                                        (i.fillStyle = a(o.fontColor, r.defaultFontColor)),
                                            ...
                                            e.isHorizontal()
                                                ...
                                                : ((l = "left" === o.position ? m + d / 2 : b - d / 2), (s = p + (v - p) / 2), (u = v - p), (g = Math.PI * ("left" === o.position ? -0.5 : 0.5))),
                                            i.save(),
                                            i.translate(l, s),
                                            i.rotate(g),
                                            (i.textAlign = "center"),
                        ...
                        var e = t.helpers,
                            ...
                            i = t.Scale.extend({
                                ...
                                determineDataLimits: function () {
                                    ...
                                    var i;
                                    void 0 !== t.options.ticks.min && ((i = e.indexOf(n, t.options.ticks.min)), (t.minIndex = i !== -1 ? i : t.minIndex)),
                                        void 0 !== t.options.ticks.max && ((i = e.indexOf(n, t.options.ticks.max)), (t.maxIndex = i !== -1 ? i : t.maxIndex)),
                                        (t.min = n[t.minIndex]),
                                        (t.max = n[t.maxIndex]);
                                },
                                buildTicks: function () {
                        ...
                        var e = t.helpers,
                            ...
                            i = t.Scale.extend({
                                ...
                                getPixelForValue: function (t) {
                                    ...
                                    return (
                                        o.isHorizontal()
                                            ? ((a = e.log10(o.end) - e.log10(r)), 0 === l ? (i = o.left) : ((n = o.width), (i = o.left + (n / a) * (e.log10(l) - e.log10(r)))))
                                            : ((n = o.height),
                                              0 !== r || u.reverse
                                                  ? 0 === o.end && u.reverse
                                                      ? ((a = e.log10(o.start) - e.log10(o.minNotZero)),
                                                        (i = l === o.end ? o.top : l === o.minNotZero ? o.top + 0.02 * n : o.top + 0.02 * n + ((0.98 * n) / a) * (e.log10(l) - e.log10(o.minNotZero))))
                                                      : 0 === l
                                                      ? (i = u.reverse ? o.top : o.bottom)
                                                      : ((a = e.log10(o.end) - e.log10(r)), (n = o.height), (i = o.bottom - (n / a) * (e.log10(l) - e.log10(r))))
                                                  : ((a = e.log10(o.end) - e.log10(o.minNotZero)),
                                                    (i = l === r ? o.bottom : l === o.minNotZero ? o.bottom - 0.02 * n : o.bottom - 0.02 * n - ((0.98 * n) / a) * (e.log10(l) - e.log10(o.minNotZero))))),
                                        i
                                    );
                                },
                                getValueForPixel: function (t) {
                    ...
                    (i = "function" == typeof i ? i : window.moment),
                        (e.exports = function (t) {
                            ...
                            t.Ticks.generators.time = function (t, e) {
                                ...
                                return (
                                    "week" === t.unit && r !== !1
                                        ? ((n = i(e.min).startOf("isoWeek").isoWeekday(r).valueOf()), (a = i(e.max).startOf("isoWeek").isoWeekday(r)), e.max - a > 0 && a.add(1, "week"), (a = a.valueOf()))
                                        : ((n = i(e.min).startOf(t.unit).valueOf()), (a = i(e.max).startOf(t.unit)), e.max - a > 0 && a.add(1, t.unit), (a = a.valueOf())),
                                    o(t, e, { min: n, max: a })
                                );
                            };
                            var u = t.Scale.extend({
                                ...
                                buildTicks: function () {
                                    ...
                                    (l.ticks = t.Ticks.generators.time({ maxTicks: h, min: i, max: o, stepSize: g, unit: f, isoWeekday: s.isoWeekday }, { min: u, max: d })), (l.max = r.max(l.ticks)), (l.min = r.min(l.ticks));
                                },
                                ...
                                getPixelForValue: function (t, n, i) {
                                    var a = this,
                                        o = null;
                                    if (
                                        (void 0 !== n && void 0 !== i && (o = a._parsedData.datasets[i][n]), null === o && ((t && t.isValid) || (t = e(a, a.getRightValue(t))), t && t.isValid && t.isValid() && (o = t.valueOf())), null !== o)
                                    )
